...
# Normal booking
#######################################################################################################################
book_appointment('Alice Smith', 'Dr. John Doe', '2024-09-20 11:30 AM')
display_appointments()
...
#######################################################################################################################
try:
    book_appointment('', 'Dr. John Doe', '2024-10-20 12:30 PM')
...
#######################################################################################################################
try:
    book_appointment(None, 'Dr. John Doe', '2024-07-20 11:30 PM')
except ValueError as e:
    print(f"Error: {e}")
